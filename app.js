...
router.get(
  ...
  clothesController.indexView
); // index 라우트 생성
router.get("/clothes/new", clothesController.new); // 생성 폼을 보기 위한 요청 처리
router.post(
  "/clothes/create",
  clothesController.create,
  clothesController.redirectView
); // 생성 폼에서 받아온 데이터의 처리와 결과를 사용자 보기 페이지에 보여주기
router.get(
  "/sports/:id",
...
router.get("/Clothes/:id/edit", clothesController.edit); // viewing을 처리하기 위한 라우트 추가
router.put(
  "/clothes/:id/update",
